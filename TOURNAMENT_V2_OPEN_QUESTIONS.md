...
### Q1. ต้องการ Supabase แยก Project หรือไม่?
...
### Q2. ข้อมูล Tournament เดิมต้องย้ายทั้งหมดหรือเริ่มรายการใหม่?
...
### Q3. Tournament และ League ใช้ Admin Account ชุดเดียวกันหรือไม่?
...
### Q4. Team Master ต้องแชร์กันหรือ Import แยก?
...
### Q5. Player คนเดิมสามารถผูกข้ามรายการ/ข้ามรุ่นอายุได้หรือไม่?
...
### Q6. กติกาใบโทษ (Discipline) ของ Tournament เป็นแบบใด?
...
### Q7. ต้องรองรับทีมอันดับ 3 ที่ดีที่สุดแบบใด?
...
### Q8. ต้องรองรับกลุ่มไม่เท่ากันหรือไม่ (และถ้าใช่ ผลกระทบต่อ Best-Third-Place ตาม Q7 อย่างไร)?
...
### Q9. กติกาการตัดผลกับทีมอันดับสุดท้ายเป็นแบบใด?
...
### Q15. งบประมาณ/แผนสำหรับ Supabase Project ที่สอง (ถ้าเลือก Q1 = Option A)?
...
### Q16. Default Result Approval Policy ที่จะใช้จริงคือแบบใด?
...
### Q23. ทีมอันดับ 3 ที่ดีที่สุดข้ามกลุ่ม (`best_ranked`) ใช้เกณฑ์เปรียบเทียบแบบใด เมื่อกลุ่มมีขนาดไม่เท่ากัน?
...
### Q24. ระยะพักขั้นต่ำระหว่างนัด (Rest-time) และจำนวนนัดสูงสุดต่อทีมต่อวัน ค่า Default คือเท่าไร?
...
## สรุปคำถามที่ Block งานมากที่สุด (Top 5)

1. **Q1** — Supabase แยก Project หรือไม่ (กระทบทุก Phase ตั้งแต่ Phase 1)
2. **Q2** — Migrate ข้อมูลเดิมหรือเริ่มใหม่ (กระทบ Phase 11-13 และ Risk Assessment ทั้งหมด)
3. **Q6/Q7/Q9** (กลุ่มกติกา Standings/Tiebreak/Discipline) — กระทบ Phase 6 และ 8 โดยตรง เพราะปัจจุบันไม่มีกติกาเหล่านี้อยู่ในโค้ดเลยแม้แต่น้อย (ตาม Current State Audit R3) ต้องขอจากเจ้าของระบบใหม่ทั้งหมด ไม่ใช่แค่ "ยืนยันของเดิม"
4. **Q16** — Default Approval Policy (กระทบ Phase 5c ทั้ง Phase โดยตรง เพราะเป็นแกนของ State Machine)
5. **Q24** — ค่า Default ระยะพัก/จำนวนนัดสูงสุดต่อวัน (กระทบ Phase 4b — ไม่มีค่า Default ที่ปลอดภัยพอให้ทีม Audit เดาแทนเจ้าของระบบ ต้องได้ตัวเลขจริงก่อนเขียน Validation Logic)

**ข้อเสนอ**: จัดประชุม 1 รอบกับเจ้าของระบบเพื่อตอบ Q1, Q2, Q3 ก่อน (ตัดสิน Architecture-level) แล้วจึงตามด้วยรอบสองสำหรับ Q6-Q9 (Business Rule), รอบสามสำหรับ Q16-Q22 (Venue Operations — ควรมีตัวแทนเจ้าหน้าที่สนามจริงร่วมด้วย), และรอบสี่สำหรับ Q23-Q28 (Scheduling/Draw — ควรมีผู้จัดโปรแกรมแข่งขันจริงร่วมด้วยเพราะเป็นคำถามเชิงปฏิบัติการจัดตาราง)
