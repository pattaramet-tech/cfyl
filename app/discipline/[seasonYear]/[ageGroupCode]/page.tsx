...
export default function DisciplineByAgeGroupPage() {
    ...
    <div className="space-y-6">
      ...
      {state === 'loading' ? (
        ...
        <div className="cfyl-section text-center space-y-3">
          ...
          <Link href="/discipline" className="cfyl-btn-secondary">ไปหน้าระเบียบวินัย</Link>
        </div>
      ) : (
        <DisciplineView seasonId={resolved.seasonId} ageGroupId={resolved.ageGroupId} />
      )}
    </div>
  );
}
